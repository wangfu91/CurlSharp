...
namespace CurlSharp
{
    ...
    public enum CurlOption
    {
        ...
        ///     </para>
        /// </summary>
        [Obsolete("This option is deprecated. Use CURLOPT_MIMEPOST instead.")]
        HttpPost = 10024,
        ...
        ///         "Transfer-AcceptEncoding: chunked" with <c>HttpHeader</c>. With
        ...
        ///         enable this by adding a header like "Transfer-AcceptEncoding: chunked" with
        ...
        ///     </para>
        /// </summary>
        [Obsolete("Use CURLOPT_UPLOAD instead")]
        Put = 54,
        ...
        ///     </note>
        /// </summary>
        [Obsolete("Use CURLOPT_XFERINFOFUNCTION instead")]
        ...
        /// <summary>
        ///     Sets the contents of the Accept-AcceptEncoding: header sent in an HTTP request,
        ///     and enables decoding of a response when a Content-AcceptEncoding: header is
        ...
        ///     gzip algorithm. If a zero-length string is set, then an Accept-AcceptEncoding:
        ...
        ///     the client side.
        /// </summary>
        [Obsolete("Use CURLOPT_SEEKFUNCTION")]
        IoctlFunction = 20130,
        ...
        ///     Socks service
        /// </summary>
        [Obsolete("Use CURLOPT_PROXY_SERVICE_NAME")]
        ...
        ///     CURLPROTO_ALL.
        /// </summary>
        [Obsolete("Use CURLOPT_PROTOCOLS_STR")]
        Protocols = 181,
        ...
        /// </summary>
        [Obsolete("Use CURLOPT_REDIR_PROTOCOLS_STR")]
        RedirProtocols = 182,
